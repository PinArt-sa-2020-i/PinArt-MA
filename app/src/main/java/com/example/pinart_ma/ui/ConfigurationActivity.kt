...
class ConfigurationActivity: AppCompatActivity()  {
    ...
    fun mostrarInformacion(){
        ...
        if (user.firstname == null){ fistNameConfiguration.text = "NotFound"}
        else{ fistNameConfiguration.text = user.firstname}
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == AddMultimediaActivity.IMAGE_PICK_CODE){
            getFile(data)
